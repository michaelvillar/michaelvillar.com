...
this.require.define({"animation":function(exports, require, module){(function() {
  var Animation, Animations, Matrix, Tween, addAnimation, dynamics, getFirstFrame, hasCommonProperties, helpers, keysForTransform, parseFrame, removeAnimation, stopAnimationsForEl,
  ...
  parseFrame = function(properties) {
    var k, match, newProperties, transform, transforms, unit, v, vString, value;
    transforms = [];
    newProperties = {};
    for (k in properties) {
      v = properties[k];
    ...
    if (transforms.length > 0) {
      ...
      newProperties['transform'] = {
        value: Matrix.fromTransform(Matrix.transformStringToMatrixString(transform)),
  ...
  removeAnimation = function(animation) {
    ...
    if (pos > -1) {
      return Animations.splice(pos, 1);
    }
  };
  ...
  Animation = (function() {
    function Animation(el, to, options) {
      var animation, k, key, pos, redraw, _i, _j, _len, _len1, _ref;
      this.el = el;
      this.to = to;
      if (options == null) {
        options = {};
      ...
      this.startFrame = parseFrame(getFirstFrame.call(this, this.to));
      this.endFrame = parseFrame(this.to);
      this.keysToInterpolate = (function() {
        var _results;
        _results = [];
        for (k in this.endFrame) {
    ...
    Animation.prototype.setOptions = function(options) {
      var complete, _base, _base1, _base2, _base3;
      if (options == null) {
        options = {};
      }
      ...
      this.options.complete = (function(_this) {
        return function() {
          _this.complete();
...
this.require.define({"dynamics":function(exports, require, module){(function() {
  var Bezier, CustomBezier, Dynamic, EaseIn, EaseInOut, EaseOut, Gravity, GravityWithForce, Linear, SelfSpring, Spring, dynamics,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  ...
  Dynamic = (function() {
    ...
    Dynamic.prototype.editable = function() {
      return false;
    };
  ...
  dynamics.EaseIn = EaseIn;

  dynamics.EaseOut = EaseOut;
...
this.require.define({"loop":function(exports, require, module){(function() {
  ...
  propertiesAtFrame = function(t, args) {
    var dValue, interpolatedMatrix, k, newValue, oldValue, progress, properties, unit, v, value, _ref;
    if (args == null) {
      args = {};
    }
    ...
    for (k in _ref) {
      v = _ref[k];
      if (this.keysToInterpolate.indexOf(k.toLowerCase()) === -1) {
        continue;
      }
      value = v.value;
      unit = v.unit;
      ...
      if (progress >= 1) {
        if (this.returnsToSelf) {
          newValue = this.startFrame[k].value;
        } else {
          newValue = this.endFrame[k].value;
        }
      }
      if (newValue == null) {
        if (k === 'transform') {
          interpolatedMatrix = Matrix.interpolate(this.startFrame[k].value.decompose(), this.endFrame[k].value.decompose(), t);
          newValue = Matrix.recompose(interpolatedMatrix);
        } else {
          oldValue = null;
          if (this.startFrame[k]) {
            oldValue = this.startFrame[k].value;
          }
