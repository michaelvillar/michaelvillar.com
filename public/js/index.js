...
(function() {
  setTimeout(function() {
    var animateLogo, animating, collapse, explode, intro, logoEl, m, maskBottomBottom, maskMBottom, maskMTop, maskTopTop, maskVBottom, speed, square, support, v;
    speed = 1;
    ...
    intro = function() {
      var contentEls, delay, el, headerEls, selector, _i, _j, _len, _len1, _results;
      animateLogo();
      if (!support) {
        delay = 0;
      } else {
